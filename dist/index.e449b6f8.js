...
})({"5aeR4":[function(require,module,exports) {
"use strict";
...
module.bundle.HMR_BUNDLE_ID = "2f05ecafe449b6f8";
...
},{}],"bfhgZ":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
var _jquery360 = require("./jquery3-6-0");
...
var _polifils = require("./polifils");
var _popup = require("./popup");
var _popupDefault = parcelHelpers.interopDefault(_popup);
var _sliderMobile = require("./slider-mobile");
var _sliderMobileDefault = parcelHelpers.interopDefault(_sliderMobile);
var _slider = require("./slider");
var _sliderDefault = parcelHelpers.interopDefault(_slider);
var _videoPopup = require("./video-popup");
var _aos = require("../../../node_modules/aos/dist/aos");
var _aosDefault = parcelHelpers.interopDefault(_aos);
var _rellax = require("../../../node_modules/rellax/rellax");
var _rellaxDefault = parcelHelpers.interopDefault(_rellax);
var _blockWithSlider = require("./blockWithSlider");
...
document.addEventListener("DOMContentLoaded", ()=>{
    ...
    (0, _popupDefault.default)();
    (0, _sliderMobileDefault.default)();
    (0, _sliderDefault.default)();
    (0, _sliderMobile.sliderMemory)();
    (0, _blockWithSlider.blockWithSlider)();
});
window.onload = ()=>{
    (0, _selectDefault.default)();
    (0, _aosDefault.default).refresh();
    if (document.documentElement.clientWidth > 500) new (0, _rellaxDefault.default)(".rellax", {
        center: true
    });
};

},{"./jquery3-6-0":"1ZTps","./viewport":"7ATiE","./select":"chpcZ","./mobile-menu":"jP5hp","./polifils":"eZiBr","./popup":"bGc7a","./slider-mobile":"c0fR9","./slider":"kXoxh","./video-popup":"kMcmY","../../../node_modules/aos/dist/aos":"eRzTM","../../../node_modules/rellax/rellax":"64yfe","./blockWithSlider":"gqAK1","./map":"hEnVR","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"1ZTps":[function(require,module,exports) {
...
},{}],"7ATiE":[function(require,module,exports) {
...
function resize() {
    ...
    if (w < 1250) {
        if (window.innerWidth > window.innerHeight) m.setAttribute(c, v + "1024," + u);
        else if (w < 500) m.setAttribute(c, v + "375," + u);
        else m.setAttribute(c, v + "768," + u);
    } else m.setAttribute(c, v + "device-width," + u);
}

},{}],"chpcZ":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "refreshHeightWhatSend", ()=>refreshHeightWhatSend);
function refreshHeightWhatSend(el) {
    const list = el.closest(".what-send__list");
    console.log(el);
    list.style.minHeight = `${el.querySelector(".what-send__content")?.offsetHeight}`;
}
function select() {
    ...
    if (listArray.length) listArray.forEach((list)=>{
        ...
        if (activeItem?.classList.contains("what-send__item") && window.innerWidth > 375) refreshHeightWhatSend(activeItem);
        itemArray.forEach((item)=>{
            item.querySelector("[select-button]")?.addEventListener("click", (e)=>{
                e.preventDefault();
                if (activeItem === item) {
                    if (activeItem.classList.contains("what-send__item") && window.innerWidth > 375) item.classList.add("active");
                    else item.classList.toggle("active");
                } else {
                    if (activeItem?.classList.contains("what-send__item") && window.innerWidth > 375) {
                ...
                if (activeItem?.classList.contains("what-send__item")) {
                    if (window.innerWidth > 375) refreshHeightWhatSend(activeItem);
                }
            });
        });
    });
...
},{}],"jP5hp":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
function mobileMenu() {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"eZiBr":[function(require,module,exports) {
(function(ELEMENT) {
...
},{}],"bGc7a":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
function popupFunc() {
    ...
    if (modalList.length) {
        modalList.forEach((modalWrap)=>{
            const openButton = modalWrap.querySelector(".btn-open-modal");
            const modal = modalWrap.querySelector(".modal");
            if (openButton && modal) openButton.addEventListener("click", ()=>{
                openPopup(overlay, modal);
            });
        });
        overlay.addEventListener("click", (e)=>{
            const el = e.target;
            if (el.classList.contains("modal-overlay") || el.classList.contains("close-btn") || el.closest(".close-btn")) closePopup(overlay);
        });
    }
}
exports.default = popupFunc;

},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"c0fR9":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "baseSliderOptions", ()=>baseSliderOptions);
parcelHelpers.export(exports, "sliderMemory", ()=>sliderMemory);
var _swiperBundleMinJs = require("./swiper/swiper-bundle.min.js");
...
function sliderMobile() {
    ...
    if (swiperEl) new (0, _swiperBundleMinJsDefault.default)(swiperEl, {
        ...baseSliderOptions,
        loop: true,
...
exports.default = sliderMobile;
function sliderMemory() {
    const swiperEl = document.querySelector(".memory .swiper");
    console.log(swiperEl);
    if (swiperEl && document.documentElement.clientWidth < 1250) new (0, _swiperBundleMinJsDefault.default)(swiperEl, {
        ...baseSliderOptions,
        spaceBetween: 30,
        slidesPerView: "auto"
    });
...
},{"./swiper/swiper-bundle.min.js":"koYwt","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"koYwt":[function(require,module,exports) {
/**
 * Swiper 8.2.4
        ...
        updateSlides: function() {
            ...
            for(let i1 = 0; i1 < p; i1 += 1){
                ...
                if (T && e.grid.updateSlide(i1, n1, p, t), "none" !== n1.css("display")) {
                    ...
                    c[i1] && (c[i1].swiperSlideSize = $), m.push($), a.centeredSlides ? (y = y + $ / 2 + E / 2 + x, 0 === E && 0 !== i1 && (y = y - r / 2 - x), 0 === i1 && (y = y - r / 2 - x), Math.abs(y) < 0.001 && (y = 0), a.roundLengths && (y = Math.floor(y)), C % a.slidesPerGroup == 0 && u.push(y), h.push(y)) : (a.roundLengths && (y = Math.floor(y)), (C - Math.min(e.params.slidesPerGroupSkip, C)) % e.params.slidesPerGroup == 0 && u.push(y), h.push(y), y = y + $ + x), e.virtualSize += $ + x, E = $, C += 1;
                }
            }
                    ...
                    if (!a1) {
                        ...
                        if (n1 >= t.minTranslate() && (n1 = t.minTranslate()), n1 <= t.maxTranslate() && (n1 = t.maxTranslate()), t.setTransition(0), t.setTranslate(n1), t.updateProgress(), t.updateActiveIndex(), t.updateSlidesClasses(), (!d1 && t.isBeginning || !u1 && t.isEnd) && t.updateSlidesClasses(), t.params.freeMode.sticky) {
                            ...
                            if (h.push(e1), s1 && (e1.delta > s1.delta || e1.direction !== s1.direction)) h.splice(0);
                                ...
                                const s2 = c > 0 ? 0.8 : 0.2;
                                o = e1, h.splice(0), l = p(()=>{
                                    t.slideToClosest(t.params.speed, !0, void 0, s2);
                                }, 0);
                            }
                            l || (l = p(()=>{
                                o = e1, h.splice(0), t.slideToClosest(t.params.speed, !0, void 0, 0.5);
                            }, 500));
                        }
            ...
            function o(e) {
                ...
                if (t.realIndex !== s.realIndex || r) {
                    ...
                    if (s.params.loop) {
                        ...
                        const e1 = s.slides.eq(o).prevAll(`[data-swiper-slide-index="${t.realIndex}"]`).eq(0).index(), a1 = s.slides.eq(o).nextAll(`[data-swiper-slide-index="${t.realIndex}"]`).eq(0).index();
                        n = void 0 === e1 ? a1 : void 0 === a1 ? e1 : a1 - o == o - e1 ? s.params.slidesPerGroup > 1 ? a1 : o : a1 - o < o - e1 ? a1 : e1, l = t.activeIndex > t.previousIndex ? "next" : "prev";
                ...
                let n1 = 1;
                const l1 = t.params.thumbs.slideThumbActiveClass;
                if (t.params.slidesPerView > 1 && !t.params.centeredSlides && (n1 = t.params.slidesPerView), t.params.thumbs.multipleActiveThumbs || (n1 = 1), n1 = Math.floor(n1), s.slides.removeClass(l1), s.params.loop || s.params.virtual && s.params.virtual.enabled) for(let e2 = 0; e2 < n1; e2 += 1)s.$wrapperEl.children(`[data-swiper-slide-index="${t.realIndex + e2}"]`).addClass(l1);
                else for(let e3 = 0; e3 < n1; e3 += 1)s.slides.eq(t.realIndex + e3).addClass(l1);
            }
            t.thumbs = {
                swiper: null
            }, a("beforeInit", ()=>{
            ...
            s({
                ...
                setTranslate: ()=>{
                    ...
                    for(let l = 0; l < e.length; l += 1){
                        ...
                        if (b || x) {
                            const e1 = (1 - Math.abs((Math.abs(c) - 0.5) / 0.5)) ** 0.5;
                        ...
                        if (a.slideShadows) {
                            ...
                            0 === e3.length && (e3 = ie(a, o)), e3.length && (e3[0].style.opacity = Math.min(Math.max((Math.abs(c) - 0.5) / 0.5, 0), 1));
                        }
...
},{}],"kXoxh":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _sliderMobileTs = require("./slider-mobile.ts");
var _swiperBundleMinJs = require("./swiper/swiper-bundle.min.js");
var _swiperBundleMinJsDefault = parcelHelpers.interopDefault(_swiperBundleMinJs);
function slider() {
    ...
    function renderNav(swiper, current, total) {
        ...
        let text = "<ul>";
        for(let i = 0; i < total; i++)if (current - 1 == i) text += `<li class="swiper-pagination-bullet active"><div class="img-wrapper"><img src="${names[i]}"></div class="img-wrapper"></li>`;
        else text += `<li class="swiper-pagination-bullet"><div class="img-wrapper"><img src="${names[i]}"></div class="img-wrapper"></li>`;
        text += "</ul>";
        return text;
    }
    if (swiperEl && document.documentElement.clientWidth > 1250) {
        const swiper = new (0, _swiperBundleMinJsDefault.default)(swiperEl, {
            ...(0, _sliderMobileTs.baseSliderOptions),
            spaceBetween: 10,
            pagination: {
                el: navigation,
                clickable: true,
...
},{"./slider-mobile.ts":"c0fR9","./swiper/swiper-bundle.min.js":"koYwt","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"kMcmY":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
const overlay = document.querySelector(".modal-overlay");
...
},{}],"64yfe":[function(require,module,exports) {
var global = arguments[3];
// ------------------------------------------
// Rellax.js
...
},{}],"gqAK1":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "blockWithSlider", ()=>blockWithSlider);
var _sliderMobileTs = require("./slider-mobile.ts");
var _swiperBundleMinJs = require("./swiper/swiper-bundle.min.js");
var _swiperBundleMinJsDefault = parcelHelpers.interopDefault(_swiperBundleMinJs);
function blockWithSlider() {
    ...
    if (blocks.length) blocks.forEach((block)=>{
        ...
        if (btnNext && btnPrev && swiperEl) new (0, _swiperBundleMinJsDefault.default)(swiperEl, {
            ...(0, _sliderMobileTs.baseSliderOptions),
            autoHeight: true,
            spaceBetween: 20,
            slidesPerView: "auto",
...
},{"./slider-mobile.ts":"c0fR9","./swiper/swiper-bundle.min.js":"koYwt","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"hEnVR":[function(require,module,exports) {
    ...
    function init() {
        ...
        adresses.forEach((item)=>{
            ...
            item.adresses.forEach((item, index)=>{
                if (!item.coorditate?.length) return;
                const MyBalloonContentLayout = ymaps.templateLayoutFactory.createClass(`<div class="map-block__info">
          <div>
          ...
          <div>
            <div class="map-block__info-time">
              ...
              <div>
                ...
                const defaultImg = item.green ? "./claster-green.74d65df0.svg" : "./claster-brown.1d7997b4.svg";
                myGeoObjects[index] = new ymaps.Placemark(item.coorditate, {
            ...
            const MyIconContentLayout = ymaps.templateLayoutFactory.createClass('<div style="color: #FFFFFF; font-weight: bold; font-size:24px;">{{ properties.geoObjects.length }}</div>');
            var myClusterer = new ymaps.Clusterer({
                clusterIcons: [
                    {
                        href: item.colorClaster ? "./claster-green.74d65df0.svg" : "./claster-brown.1d7997b4.svg",
                        size: [
                            50,
                            50
                        ],
...
},{}]},["5aeR4","bfhgZ"], "bfhgZ", "parcelRequireab20")

//# sourceMappingURL=index.e449b6f8.js.map
