        ...
        itemArray.forEach((item)=>{
            ...
            (ref = item.querySelector("[select-button]")) === null || ref === void 0 ? void 0 : ref.addEventListener("click", (e)=>{
                ...
                if (activeItem === item) {
                    ...
                    if ((activeItem === null || activeItem === void 0 ? void 0 : activeItem.classList.contains("what-send__item")) && window.innerWidth > 375) {
...
document.querySelectorAll(".map-block__item").forEach((city, id)=>{
    ...
    city.querySelectorAll("li").forEach((li)=>{
        ...
        cityItem.adresses.push({
            coorditate: JSON.parse(a === null || a === void 0 ? void 0 : a.getAttribute("data-map")),
            adres: a === null || a === void 0 ? void 0 : a.textContent,
            dop: (ref = li.querySelector(".map-block__dop")) === null || ref === void 0 ? void 0 : ref.textContent,
    ...
    function init() {
        ...
        $a31eb1c22e8a28d9$var$adresses.forEach((item)=>{
            ...
            item.adresses.forEach((item, index)=>{
                var ref, ref1, ref2;
                if (!((ref = item.coorditate) === null || ref === void 0 ? void 0 : ref.length)) return;
                const MyBalloonContentLayout = ymaps.templateLayoutFactory.createClass(`<div class="map-block__info">
          <div>
            <div class="map-block__types">
              ${((ref1 = item.types) === null || ref1 === void 0 ? void 0 : ref1.innerHTML) ? (ref2 = item.types) === null || ref2 === void 0 ? void 0 : ref2.innerHTML : ""}
            </div>
...
//# sourceMappingURL=index.01a9e1b3.js.map
